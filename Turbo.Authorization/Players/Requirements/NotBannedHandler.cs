...
public sealed class NotBannedHandler : IRequirementHandler<NotBannedRequirement, PlayerLoginContext>
{
    public Task<AuthorizationResult> HandleAsync(
        ...
        context.IsBanned
            ? Task.FromResult(
                new AuthorizationResult(false, [new Failure("PLAYER_BANNED", "Player is banned.")])
            )
