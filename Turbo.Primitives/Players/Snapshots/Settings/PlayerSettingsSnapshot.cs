...
public sealed record PlayerSettingsSnapshot
{
    [Id(0)]
    ...
    [Id(6)]
    public required int ChatStyleId { get; init; }

    [Id(7)]
    public required ChatSizeType ChatFontSize { get; init; }
    ...
    [Id(13)]
    public required bool WiredPlayTestMode { get; init; }

    [Id(14)]
    public required int WiredVariableSyntaxMode { get; init; }

    [Id(15)]
    public required bool WiredWhisperDisabled { get; init; }

    [Id(16)]
    public required bool WiredShowAllNotifications { get; init; }
