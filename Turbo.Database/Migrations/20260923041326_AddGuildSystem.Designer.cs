...
namespace Turbo.Database.Migrations
{
    ...
    [Migration("20260923041326_AddGuildSystem")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Turbo.Database.Entities.Catalog.CatalogOfferEntity", b =>
                {
                    ...
                    b.Property<int?>("ClubGiftDaysRequired")
                        .HasColumnType("int")
                        .HasColumnName("club_gift_days_required");
            ...
            modelBuilder.Entity("Turbo.Database.Entities.Catalog.CatalogProductEntity", b =>
                {
                    ...
                    b.Property<int>("SubscriptionDays")
                        ...
                        .HasColumnType("int")
                        .HasDefaultValue(0)
                        .HasColumnName("subscription_days");
            ...
            modelBuilder.Entity("Turbo.Database.Entities.Furniture.BuildersClubFurnitureEntity", b =>
                {
                    b.Property<int>("RoomEntityId")
                        .HasColumnType("int")
                        .HasColumnName("room_id");

                    b.Property<int>("RoomObjectId")
                        .HasColumnType("int")
                        .HasColumnName("room_object_id");
                    ...
                    b.Property<int>("PlacedByPlayerEntityId")
                        .HasColumnType("int")
                        .HasColumnName("placed_by_player_id");
                    ...
                    b.HasKey("RoomEntityId", "RoomObjectId");

                    b.HasIndex("FurnitureDefinitionEntityId");

                    b.HasIndex("PlacedByPlayerEntityId");

                    b.ToTable("builders_club_furniture");
                });
            ...
            modelBuilder.Entity("Turbo.Database.Entities.Guilds.GuildBadgePartEntity", b =>
                {
                    ...
                    b.HasIndex("PartType", "PartId")
                        .IsUnique();

                    b.ToTable("guild_badge_parts");
                });

            modelBuilder.Entity("Turbo.Database.Entities.Guilds.GuildColorEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex("Slot", "ColorId")
                        .IsUnique();

                    b.ToTable("guild_colors");
                });
            ...
            modelBuilder.Entity("Turbo.Database.Entities.Guilds.GuildEntity", b =>
                {
                    ...
                    b.Property<int>("GuildType")
                        .HasColumnType("int")
                        .HasDefaultValue(0)
                        .HasColumnName("guild_type");
                    ...
                    b.Property<int>("PrimaryColorId")
                        .HasColumnType("int")
                        .HasColumnName("primary_color_id");

                    b.Property<int>("RightsLevel")
                        .HasColumnType("int")
                        .HasDefaultValue(1)
                        .HasColumnName("rights_level");
            ...
            modelBuilder.Entity("Turbo.Database.Entities.Guilds.GuildMemberEntity", b =>
                {
                    ...
                    b.HasIndex("GuildEntityId", "PlayerEntityId")
                        .IsUnique();

                    b.HasIndex("GuildEntityId", "Rank");
            ...
            modelBuilder.Entity("Turbo.Database.Entities.Players.PlayerClubGiftEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Turbo.Database.Entities.Players.PlayerNavigatorSavedSearchEntity", b =>
                {
                    ...
                    b.HasIndex("PlayerEntityId", "SearchId")
                        .IsUnique();
            ...
            modelBuilder.Entity("Turbo.Database.Entities.Players.PlayerOutfitEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex("PlayerEntityId", "SlotId")
                        .IsUnique();

                    b.ToTable("player_outfits");
                });
            ...
            modelBuilder.Entity("Turbo.Database.Entities.Players.PlayerSettingsEntity", b =>
                {
                    ...
                    b.Property<int>("ChatBubbleWidth")
                        .HasColumnType("int")
                        .HasDefaultValue(1)
                        .HasColumnName("chat_bubble_width");
                    ...
                    b.Property<int>("ChatScrollSpeed")
                        .HasColumnType("int")
                        .HasDefaultValue(1)
                        .HasColumnName("chat_scroll_speed");
                    ...
                    b.Property<int>("FurniVolume")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(100)
                        .HasColumnName("furni_volume");

                    b.Property<int>("GenericVolume")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(100)
                        .HasColumnName("generic_volume");

                    b.Property<int?>("HomeRoomId")
                        .HasColumnType("int")
                        .HasColumnName("home_room_id");

                    b.Property<bool>("NavigatorLeftPaneHidden")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("tinyint(1)")
                        .HasDefaultValue(false)
                        .HasColumnName("navigator_left_pane_hidden");

                    b.Property<int>("NavigatorResultsMode")
                        .HasColumnType("int")
                        .HasDefaultValue(1)
                        .HasColumnName("navigator_results_mode");

                    b.Property<int>("NavigatorWindowHeight")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(400)
                        .HasColumnName("navigator_window_height");

                    b.Property<int>("NavigatorWindowWidth")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(425)
                        .HasColumnName("navigator_window_width");

                    b.Property<int>("NavigatorWindowX")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(427)
                        .HasColumnName("navigator_window_x");

                    b.Property<int>("NavigatorWindowY")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(41)
                        .HasColumnName("navigator_window_y");

                    b.Property<int>("OnlineIndicatorPreference")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(0)
                        .HasColumnName("online_indicator_preference");
                    ...
                    b.Property<bool>("RoomCameraFollowDisabled")
                        ...
                        .HasColumnType("tinyint(1)")
                        .HasDefaultValue(false)
                        .HasColumnName("room_camera_follow_disabled");

                    b.Property<bool>("RoomInvitesIgnored")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("tinyint(1)")
                        .HasDefaultValue(false)
                        .HasColumnName("room_invites_ignored");
            ...
            modelBuilder.Entity("Turbo.Database.Entities.Players.PlayerSubscriptionEntity", b =>
                {
                    ...
                    b.Property<int>("PeriodsPurchased")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(0)
                        .HasColumnName("periods_purchased");
                    ...
                    b.Property<int>("TotalDaysSubscribed")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(0)
                        .HasColumnName("total_days_subscribed");
            ...
            modelBuilder.Entity("Turbo.Database.Entities.Room.RoomEntity", b =>
                {
                    ...
                    b.Property<bool>("HiddenByBc")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("tinyint(1)")
                        .HasDefaultValue(false)
                        .HasColumnName("hidden_by_bc");
                    ...
                    b.Property<bool>("IdleAutokickEnabled")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("tinyint(1)")
                        .HasDefaultValue(false)
                        .HasColumnName("idle_autokick_enabled");

                    b.Property<int>("IdleAutokickTimeoutSeconds")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(0)
                        .HasColumnName("idle_autokick_timeout_seconds");

                    b.Property<bool>("IdleSleepEnabled")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("tinyint(1)")
                        .HasDefaultValue(false)
                        .HasColumnName("idle_sleep_enabled");

                    b.Property<int>("IdleSleepTimeoutSeconds")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(0)
                        .HasColumnName("idle_sleep_timeout_seconds");
                    ...
                    b.Property<bool>("LeaveOnDoorTile")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("tinyint(1)")
                        .HasDefaultValue(false)
                        .HasColumnName("leave_on_door_tile");

                    b.Property<bool>("MuteAllPets")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("tinyint(1)")
                        .HasDefaultValue(false)
                        .HasColumnName("mute_all_pets");
            ...
            modelBuilder.Entity("Turbo.Database.Entities.Room.RoomEventEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("NavigatorEventCategoryEntityId")
                        .HasColumnType("int")
                        .HasColumnName("category_id");
                    ...
                    b.HasIndex("NavigatorEventCategoryEntityId");
            ...
            modelBuilder.Entity("Turbo.Database.Entities.Furniture.BuildersClubFurnitureEntity", b =>
                {
                    ...
                    b.HasOne("Turbo.Database.Entities.Players.PlayerEntity", "PlacedByPlayerEntity")
                        .WithMany()
                        .HasForeignKey("PlacedByPlayerEntityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("PlacedByPlayerEntity");
            ...
            modelBuilder.Entity("Turbo.Database.Entities.Room.RoomEventEntity", b =>
                {
                    b.HasOne("Turbo.Database.Entities.Navigator.NavigatorEventCategoryEntity", "NavigatorEventCategoryEntity")
                        .WithMany()
                        .HasForeignKey("NavigatorEventCategoryEntityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("NavigatorEventCategoryEntity");
